$content = Get-Content 'Setup-MCP.ps1' -Raw
$fixed = $content -replace '("@)\s*(# SIG # Begin signature block)', '$1}$2$2'
$fixed | Set-Content 'Setup-MCP.ps1' -Encoding UTF8
Write-Host "Fixed missing closing brace in Setup-MCP.ps1
# SIG # Begin signature block
# MIIaSQYJKoZIhvcNAQcCoIIaOjCCGjYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpwTlUOHfzCZ2k
# XS9C91nPg2512X+MEwOs4yPz/udscqCCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgJhd/NOKjJY0YzLIzCX85
# HwBwrtymN6j+G1BVS4h1ou4wDQYJKoZIhvcNAQEBBQAEgYANe30o6DXDw8fjuxxF
# S5WdqaOrduq97YVdr0P10n3IWMok5/mt2UQpZzWRzvKPGlM4Mg+Cq/Hy4QSL5f4e
# J3CwtTCpyGwiVdCguoZJGfgS40CbjE0K0URr8lDqHgVxZBkZB/iUEHeWmNhDfYfI
# RcUdGri6UMaWhbC9uMhiA1Hgn6GCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MTkyMjE1MjdaMC8GCSqGSIb3DQEJBDEiBCDSiunrbl3LqHFgQkSC+VnIA27dCmpa
# 6T7xwrBvUX/CMzANBgkqhkiG9w0BAQEFAASCAgBZbbjSTBjSpgIfqGRHgD3vfFaF
# Xo3+GeHlwW0qBtuTZELmm/dH4eCzZ3qGroiPtLGW81Z22zQSzEfiRHaBB1edTdnr
# IOH3tWZYOt1hKP6A0fUjlFMm8+sRNHjOJeHsinOCfVzr2o6jlKWWuESan3ZWcQip
# Azs+TF/jl7tursmPGRgAuaAha0hjhXyRzOQvadZhV4j5lgmDROd1Q0A8jWcf76Vb
# QhYlLIAbdzPc2KplsYNjW6m1s+t35YkaGzgN4kxaWSHYLdFVRpO4Lg4TxQVcZOuW
# SUTJis9TK/3od+7gRVNMED8TKMrkKNs8Bivb8SvJ+8otjOjENMgrpxu3XvapnlA6
# pIzaon14KTd6jdUIrDTYlDK/xArzoSWnmLF+CjdjSt2jZlBR6dzgzfbDnkH3bJH8
# 5b3lGq1haoBygXDCHjeq3K1kmdqdG7n9wY8aLjkc8MnubXSWWjKn0sALba+FuNSr
# ratCiKwsUJzBRpo2KvjI6oEIZCKoCyie0BaWiZxipipSYH83le7xn08n5S7ghExt
# vAHp+BPfMaqmQe1vZ0tiBHzvLrS9UiJlbG+xq1Or3ju3BikIeI+R9vNKG4Qp4gsU
# ldQl6tinS/08N+K9VSIaBFakHDJDLFG21Ze32FlaPWEaU1nmljvO+8yIfYoTsT6Y
# GyfT+WE/EWvGzS4dqQ==
