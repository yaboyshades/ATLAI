# Super Alita MCP Server Launcher
# This script starts the MCP server and registers the Super Alita tools

# Define script parameters
param(
    [switch]$StartServer = $false,
    [switch]$RegisterTools = $false,
    [switch]$Both = $false,
    [string]$HostName = "localhost",
    [int]$Port = 5678
)

# Default behavior: do both if no specific flag is provided
if (-not ($StartServer -or $RegisterTools)) {
    $Both = $true
}
...
function Start-MCPServer {
    ...
    Write-Host "Starting MCP server on ${HostName}:${Port}..."
    $env:MCP_HOST = $HostName
    $env:MCP_PORT = $Port
    
    # Start the server in a new PowerShell window
    $serverCommand = "python -m src.mcp.server"
...
# Function to register Super Alita tools
function Register-SuperAlitaTools {
    Write-Host "Registering Super Alita tools..."
    python scripts/register_super_alita_tools.py
}

# Main execution logic
if ($StartServer -or $Both) {
    Start-MCPServer -HostName $HostName -Port $Port
}

if ($RegisterTools -or $Both) {
    Register-SuperAlitaTools
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD2a3pvVnvMdH2c
# dVEn7uSS6E2OI/wVYZgJeWvhSWmbaaCCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg28ws8jULnzxAT8CTQs7c
# MUQl0imqtUmRNL1/CfVRt4wwDQYJKoZIhvcNAQEBBQAEgYCFg+niHeAAl6vrNitB
# UK2ffvhDyJSurxFliGdX49tRHrV7U9bpdJFxlqgk/EvnRiPrmTwmITPk58nf5I82
# x+HmjYoVV1Yosv3QXTiUxgF089UHeNbRv1Z4MOnjFJUr6mrgHrYZ85M6b1Z4CM+C
# 57HJ1LLUCRIK7uP02scXe+7VM6GCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MTkwNjE2NDFaMC8GCSqGSIb3DQEJBDEiBCCyTZREHXjRQcKsyx7XbazZPv4eVOHf
# P18uV+4FFFf5zzANBgkqhkiG9w0BAQEFAASCAgCw4C9Y1Pc34eX0dMuLkgtNDaX7
# rUbAJOn/cWIzwgxED9OGhR8rhiNttbjnn/bYaHLSZ9IS0RC4lrulhVkzrZGpTz4c
# Thl6uZrHkyzJuQKJRBvhCXD1DPwxrvvcl4yirPp4//Ni3XrXMnenCW2Z6ia9L7Bv
# xkgfYD8lC9/+F9dZEIcWwjfnr18FFiQSgOXfgiSVWFbfPShO3CFBOHmeLI9M6tBe
# REAUO4zjG3LAVG3SXcE4I77+0CdME+MzTU+jWvVCpfHRLk1ZvnM0oImAN6ufPfjQ
# 7FiNnnVEBjloLgZngtRgJIoMEciNsV+8QiF/VgJlHYltyRYZ7RV/TLi8MOch07WY
# tizi+Byhr37+5mUyxInUMWmRju4Oe8STsM4NKrKTfcXG/d8aHmJGgJkYG4h6fCQj
# l6fU/GIkQRh/fBYapReDhIv/cRbkKrXVM9klL79Mbl5+9W3r3AxdY4+OlCjNl4g0
# anclS102Hbki56zeD74OrevcMoYo1Lj2h8q33CCFlTkYwaaW5g0zjXCrOdFyiHtF
# zRpGSbYQmF8QoPTxo5QKMr2jP/RU8rTW9S5HyF/Q4UT8OUfK0jLQgGaSw0kq3tg1
# FH8uL6L2wedTVao+Csvr2pm0t7IrouzbOScSKrEJu7M0StMBlTydFWpqKgYxN82A
# 6LVh3B+Du9ksVgn5Xg==
